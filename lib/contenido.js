...
export const perfil = {
  ...
  parrafos: [
    ...
    'Trabajo con comunicación abierta y honestidad sobre el estado real de las cosas. Prefiero decir “esto todavía no funciona” antes que sostener una demo que no se banca. Y cuando algo no da resultado, lo mido, lo digo y lo documento.',
    'Diseño y construyo productos de punta a punta, formando parte de un equipo de tres personas en la que buscamos entregar valor de manera continua.',
  ],
  chips: [
...
export const comoTrabajo = {
  ...
  items: [
    ...
    {
      num: '04',
      titulo: 'Diseño frontend: Prototipando con agentes de IA',
      cuerpo:
        'Subagentes y herramientas propias o comunitarias, que leen el diseño directamente desde los prototipos para reducir tokens de contexto y llamados de herramienta para conseguir implementarlas. Menos costo operativo por cada iteración.',
    },
  ],
  // Postura personal, no una pieza mas del sistema: por eso va como bloque
  // aparte y no como un item numerado.
  comunicacion: {
    rotulo: 'Sobre comunicación',
    parrafos: [
      'Trabajo con honestidad y transparencia. Necesito entender lo que estoy haciendo para sentirme seguro de ello y poder explicarlo: por eso hago muchas preguntas, y suelo detenerme bastante en los detalles.',
      'La mejor inversión de tiempo se hace escuchando a los clientes y a los usuarios, no implementando funcionalidades que nadie va a usar o encontrar.',
    ],
  },
  cierre:
...
const correo = 'hernandez.joaquin346@gmail.com';

export const contacto = {
  titulo: 'Trabajemos juntos',
  // Fuente única de la dirección: la usan el link de Email y el formulario.
  email: correo,
  frase:
    '¿Tenés un proyecto donde haga falta alguien que se haga cargo del problema completo, no solo de su parte técnica? Escribime.',
  links: [
    { rotulo: 'Email', texto: correo, href: `mailto:${correo}` },
