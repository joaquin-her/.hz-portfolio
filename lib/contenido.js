...
export const navegacion = [
  { id: 'trayectoria', num: '01', label: 'Trayectoria' },
  { id: 'capacidades', num: '02', label: 'Capacidades' },
  { id: 'proyectos', num: '03', label: 'Proyectos' },
  { id: 'como-trabajo', num: '04', label: 'Cómo trabajo' },
  { id: 'aprendizajes', num: '05', label: 'Lo que aprendí' },
...
export const proyectos = [
  {
    ...
    imagen: {
      estado: 'disponible',
      titulo: 'Diagrama de arquitectura del MCP',
      archivo: 'components_diagram.png',
      alto: 320,
    },
    parrafos: [
  ...
  },
  {
    ...
    imagen: {
      estado: 'pendiente',
      titulo: 'Captura del showroom — requiere autorización del dueño',
      alto: 400,
    },
    actos: [
      {
  ...
  },
  {
    ...
    imagen: {
      estado: 'pendiente',
      titulo: 'Captura de alethIA — la demo está publicada',
      alto: 300,
    },
    parrafos: [
...
export const comoTrabajo = {
  intro:
    'Trabajo con un equipo de tres personas en un producto desde cero. Mi aporte principal no son líneas de código: es el sistema que nos permite desarrollar rápido, iterar con menos riesgo y sostener el ritmo sin quemarnos. Esto es lo que construimos para lograrlo.',
  items: [
    {
      num: '01',
  ...
  placeholder: 'Diagrama del flujo de trabajo del equipo',
};
